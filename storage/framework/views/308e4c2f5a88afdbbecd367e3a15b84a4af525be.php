       ...
       <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w categoria-item">
                    <img src="<?php echo e($categoria->imagen); ?>" alt="<?php echo e($categoria->nombre); ?>">
                    <a href="/productos/<?php echo e($categoria->slug); ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
...
<?php /* /home/jetro/gomarket1/resources/views/website/home.blade.php */ ?>