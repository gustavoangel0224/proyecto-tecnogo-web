			...
			<div class="wrap-menu-desktop ">
				<nav class="limiter-menu-desktop container">	
					...
					<div class="wrap-icon-header flex-w flex-r-m">
                       <?php if(\App\Models\Cliente::getUser() == null): ?>
                       ...
                       <?php else: ?>
                           <div class="usuario-sesion">
                               <a href="javascript:;" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
                                   <?php echo e(\App\Models\Cliente::getUser()->nombre); ?>
                       ...
                       <?php endif; ?>
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?php echo e(\App\Models\Carrito::myCart()->count()); ?>">
...
<!-- lo que me falló -->		
		<div class="wrap-header-mobile">	
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart " data-notify="<?php echo e(\App\Models\Carrito::myCart()->count()); ?>">
					<i class="zmdi zmdi-shopping-cart color-hover-carrito"></i>
				</div>
			</div>
		...
		<div class="header-cart flex-col-l p-l-65 p-r-25">
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
                    <?php $__currentLoopData = \App\Models\Carrito::myCart()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="header-cart-item flex-w flex-t m-b-12">
                            <div class="header-cart-item-img">
                                <img src="<?php echo e($producto->articulo->imagen); ?>" alt="<?php echo e($producto->articulo->nombre); ?>">
                            </div>

                            <div class="header-cart-item-txt p-t-8">
                                <a href="/<?php echo e($producto->articulo->SKU); ?>/<?php echo e($producto->articulo->id); ?>" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
                                    <?php echo e($producto->articulo->nombre); ?>

                                </a>

                                <span class="header-cart-item-info">
                                    <?php echo e($producto->cantidad); ?> x $<?php echo e(number_format($producto->articulo->precioVenta, 2)); ?>
				...
				<div class="w-full">
					<div class="header-cart-total w-full p-tb-40">
						Total: $<?php echo e(number_format(\App\Models\Carrito::getTotal(), 2)); ?>
...
<?php /* /home/jetro/gomarket1/resources/views/website/layout/default.blade.php */ ?>